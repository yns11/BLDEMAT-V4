...
CREATE TABLE IF NOT EXISTS bl_demat.suivi_bl (
  ...
  desadv_rapproche    BOOLEAN,               -- numéro retrouvé dans un DESADV (job)
...
-- ----------------------------------------------------------------------------
-- Table 12 : audit_bl — historique des BL (qui a changé quoi, quand).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table 13 : qualite_extraction — valeur IA vs valeur validée, par champ.
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table 14 : ecrans_utilisateur — filtres/tri/colonnes sauvegardés par vue.
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table 15 : notifications — journal des événements notifiables (ex. passage
...
--   bl_demat.notifications, bl_demat.ecrans_utilisateur TO "<SP_APP_ADMINISTRATION>";
...
-- GRANT USAGE, SELECT ON SEQUENCE bl_demat.notifications_id_seq,
--   bl_demat.audit_bl_id_seq TO "<SP_APP_ADMINISTRATION>";
