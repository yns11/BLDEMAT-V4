...
-- ----------------------------------------------------------------------------
-- Table 10 : notifications — journal des événements notifiables (ex. passage
...
--   bl_demat.adresses, bl_demat.sites_logistiques TO "<SP_APP_CREATION>";
...
--   bl_demat.sites_logistiques, bl_demat.notifications TO "<SP_APP_ADMINISTRATION>";
